...
@pytest.fixture
def fixture_NodeProps(fixture_res_schema):
    nodeprops = NodeProps(fixture_res_schema)
    return nodeprops


def test_get_schema_name(fixture_NodeProps):
    nodeprops = fixture_NodeProps
    assert nodeprops.get_schema_name() == "Unaligned Reads File"


def test_get_prop_names(fixture_NodeProps):
    nodeprops = fixture_NodeProps
    expected = [
        'type',
        'id',
...
def test_get_prop_info_not_found(fixture_NodeProps, caplog):
    nodeprops = fixture_NodeProps
...
def test_get_data_type(fixture_NodeProps):
    nodeprops = fixture_NodeProps
    assert nodeprops.get_data_type('run_id') == "string"


def test_get_data_type_pattern(fixture_NodeProps):
    nodeprops = fixture_NodeProps
    assert (
...
def test_get_data_type_enum(fixture_NodeProps):
    nodeprops = fixture_NodeProps
    assert nodeprops.get_data_type('file_state') == "enum"


def test_get_data_type_none(fixture_NodeProps):
    nodeprops = fixture_NodeProps
    assert nodeprops.get_data_type('state') is None


def test_get_data_type_warn(fixture_NodeProps, caplog):
    nodeprops = fixture_NodeProps
    # check for not found warning
    with caplog.at_level("WARNING"):
        assert nodeprops.get_data_type('state') is None
...
def test_get_data_type_not_found(fixture_NodeProps, caplog):
    nodeprops = fixture_NodeProps
    # check for not found warning
    with caplog.at_level("WARNING"):
...
def test_get_description(fixture_NodeProps):
    nodeprops = fixture_NodeProps
    expected = (
...
def test_get_description_prop_with_term(fixture_NodeProps):
    nodeprops = fixture_NodeProps
    expected = (
...
def test_get_description_not_found(fixture_NodeProps, caplog):
    nodeprops = fixture_NodeProps
    # check for not found warning
    with caplog.at_level("WARNING"):
